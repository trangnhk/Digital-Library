 ...
 * @author Admin
 */
public class LibrarianDocumentResponseDTO {
    ...
    public static LibrarianDocumentResponseDTO fromDocument(Document document) {
        LibrarianDocumentResponseDTO dto = new LibrarianDocumentResponseDTO();
